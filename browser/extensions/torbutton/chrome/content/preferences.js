...
(function(window, document) {
  ...
  window.torbutton_set_slider = torbutton_set_slider;
  window.torbutton_set_custom = torbutton_set_custom;
  window.torbutton_init_security_ui = torbutton_init_security_ui;
  window.torbutton_save_security_settings = torbutton_save_security_settings;
  window.torbutton_set_learn_more_links = torbutton_set_learn_more_links;
  window.adjustDialogSize = adjustDialogSize;
